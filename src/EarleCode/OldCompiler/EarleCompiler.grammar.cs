...
using System.Linq;
using EarleCode.OldCompiler.Grammar;
using EarleCode.Runtime.Operators;

namespace EarleCode.OldCompiler
{
	internal partial class EarleCompiler
	{
	    ...
	    private void InitializeGrammarProcessor()
	    {
			...
			/**/SyntaxGrammarProcessor.AddRule("VECTOR", false, "( EXPRESSION , EXPRESSION , EXPRESSION , EXPRESSION )");
