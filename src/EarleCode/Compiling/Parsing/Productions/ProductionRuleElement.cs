...
namespace EarleCode.Compiling.Parsing.Productions
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ProductionRuleElement{TTokenType}" /> class.
        /// </summary>
        /// <param name="tokenType">Type of the token.</param>
        /// <param name="value">The value.</param>
        public ProductionRuleElement(TTokenType tokenType, string value) : this(ProductionRuleElementType.Terminal,
            tokenType, value)
        {
        }
        ...
        /// <param name="tokenType">Type of the token.</param>
        /// <param name="value">The value.</param>
        public ProductionRuleElement(ProductionRuleElementType type, TTokenType tokenType, string value)
        {
            Type = type;
            TokenType = tokenType;
            Value = value;
        ...
        ///     Initializes a new instance of the <see cref="ProductionRuleElement{TTokenType}" /> class.
        /// </summary>
        public ProductionRuleElement() : this(ProductionRuleElementType.TerminalEmpty, null)
        {
        }
        ...
        /// </summary>
        public Token<TTokenType> Token =>
            Type == ProductionRuleElementType.TerminalEmpty
                ? Token<TTokenType>.Empty
                : new Token<TTokenType>(TokenType, Value);
