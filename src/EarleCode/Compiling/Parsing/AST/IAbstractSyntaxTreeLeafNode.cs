...
{
    /// <summary>
    ///     Contains the methods of a leaf AST node which contains a token of type <typeparamref name="TTokenType" />.
    /// </summary>
    /// <typeparam name="TTokenType">The type enum of the token type inside this node.</typeparam>
    public interface IAbstractSyntaxTreeLeafNode<TTokenType> : IAbstractSyntaxTreeNode
