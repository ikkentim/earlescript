...
{
    /// <summary>
    ///     Represents a tokenizer for tokens of the specified <typeparamref name="TTokenType" />.
    /// </summary>
    /// <typeparam name="TTokenType">The type of the tokens resulting from the lexer.</typeparam>
    public interface ILexer<TTokenType> where TTokenType : struct, IConvertible
    {
        /// <summary>
        ...
        IEnumerable<Token<TTokenType>> Tokenize(string input, string file = null);
    }
}