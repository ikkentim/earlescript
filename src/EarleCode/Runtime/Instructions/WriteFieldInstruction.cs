...
{
    /// <summary>
    ///     Represents the WRITE.F instruction which writes the value from below the top of the stack to the specified field to
    ///     the structure on the top of the stack.
    /// </summary>
