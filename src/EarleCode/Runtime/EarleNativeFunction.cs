...
namespace EarleCode.Runtime
{
    public abstract class EarleNativeFunction : EarleFunction
    {
        ...
        private class NativeRuntimeLoop : EarleRuntimeLoop
        {
            private readonly EarleValue[] _arguments;
            private readonly EarleNativeFunction _native;

            public NativeRuntimeLoop(EarleRuntime runtime, EarleNativeFunction native, EarleValue[] arguments, EarleValue target)
