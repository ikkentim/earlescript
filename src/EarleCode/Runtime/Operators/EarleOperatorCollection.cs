...
namespace EarleCode.Runtime.Operators
{
	public sealed class EarleOperatorCollection
	{
		private readonly Dictionary<Tuple<OpCode, Type, Type>, Tuple<bool, Func<EarleValue, EarleValue, EarleValue>>>
			_binaryOperators = new Dictionary<Tuple<OpCode, Type, Type>, Tuple<bool, Func<EarleValue, EarleValue, EarleValue>>>();
		...
		public void AddBinaryOperator(OpCode @operator, Type[] supportedTypes, Func<EarleValue, EarleValue, EarleValue> func,
