	...
	internal partial class EarleCompiler
	{
		...
		private void InitializeGrammarProcessor()
		{
			...
			SyntaxGrammarProcessor.AddRules("OPERATOR_BINARY", false,
				EarleOperators.BinaryOperators.OrderByDescending(o => o.Length));
			SyntaxGrammarProcessor.AddRules("OPERATOR_UNARY", false,
				EarleOperators.UnaryOperators.OrderByDescending(o => o.Length));
			SyntaxGrammarProcessor.AddRules("OPERATOR_ASSIGNMENT", false,
				EarleOperators.AssignmentOperators.OrderByDescending(o => o.Length));
			SyntaxGrammarProcessor.AddRules("OPERATOR_MOD_ASSIGNMENT", false,
				EarleOperators.AssignmentModOperators.OrderByDescending(o => o.Length));
		}
	}
}